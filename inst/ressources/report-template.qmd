...
execute:
  echo: false
params:
  object: "adult_tar.rds" # will have to be passed - will be a mandatory parameter  -> path to a rds export of a targeter object
