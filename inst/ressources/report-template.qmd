...
"This report contains a snapshot of the specific subpopulation **«",
    label(object$target,metadata, var_field = params$metadata_var_field, label_field= params$metadata_var_label ),"» == ", object$target_reference_level, "**\n\n",
...
for (ivar in names(vars)){
  ...
  title_text <- paste(title_text, paste(" IV:", round(iprofile$IV, 3), collapse = "\\"))
  if (tolower(ivar_label)!=tolower(ivar)){
    title_text <- paste(title_text,  ivar_label, collapse = "\\") 
    ## https://stackoverflow.com/questions/33266938/how-to-break-a-long-headed-line-in-markdown-pandoc
  }
