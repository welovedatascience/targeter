...
execute:
  echo: false
params:
  object: "" # will have to be passed as mandatory parameter  title: "targeter analysis"
...
format:
  ...
  pptx: 
    df-print: "kable" 
    doc-reference: $TARGETER_PARAM_template-pptx$  # apparently can't be managed by params :(
